...
class ReadyForDeliveryCommandTest {
    ...
    void testExecute_WithValidOrderId() {
        // Act
        readyForDeliveryCommand.execute(validOrderId);

        // Assert
        verify(deliveryService, times(1)).updateStatus(validOrderId, StatusEnum.READY_FOR_DELIVERY);
    }
    ...
    void testExecute_WithNullOrderId() {
        ...
        NullPointerException exception = assertThrows(NullPointerException.class, () ->
                readyForDeliveryCommand.execute(nullOrderId)
        );
